  ...
  return (
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            <div className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                ...
                <ul className='flex gap-8'>
                    <li><a href="#hero" className='hover:text-primary transition-all'>Home</a></li>
                    <li><a href="#services" className='hover:text-primary transition-all'>Services</a></li>
                    <li><a href="#our-work" className='hover:text-primary transition-all'>Our Work</a></li>
                    <li><a href="#contact-us" className='hover:text-primary transition-all'>Contact Us</a></li>
                </ul>
            </div>
        ...
        <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
            <p>Copyright 2026 @ JM - All rights reserved.</p>
